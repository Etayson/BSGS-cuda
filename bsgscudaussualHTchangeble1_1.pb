...
ForEach publist()
  ...
  Title$=Str(listpos)+"/"+Str(ListSize(publist()) )+" "+Curve::m_gethex32(REALPUB\x)
  ConsoleTitle(Title$)
...
; CursorPosition = 3963
; FirstLine = 1651
; Folding = DAAgAAAgMAE1
; EnableThread
; EnableXP
; Executable = bsgscudaHT2.exe
; DisableDebugger
; CommandLine = -infile PUBS.txt -pk 49dccfd96dc5df56487436f5a1b18c4f5d34f65ddb48cb5e0000000000000000 -pke 49dccfd96dc5df56487436f5a1b18c4f5d34f65ddb48cb5effffffffffffffff