...
Define  blocktotal.i
Define pparam.w
Define.s Gx , Gy, p, privkey,  pball$, walletall$, mainpub, addpubs
...
Define *PrivBIG, PubkeyBIG.CoordPoint, *MaxNonceBIG, FINDPUBG.CoordPoint, ADDPUBG.CoordPoint, *bufferResult, *addX, *addY, *PRKADDBIG, PUBADDBIG.CoordPoint, REALPUB.CoordPoint
Define Defdevice$, HT_POW=25
...
mainpub.s = "04B1985389D8AB680DEDD67BBA7CA781D1A9E6E5974AAD2E70518125BAD5783EB5355F46E927A030DB14CF8D3940C1BED7FB80624B32B349AB5A05226AF15A2228"
...
privkey.s="0x49dccfd96dc5df56487436f5a1b18c4f5d34f65ddb48cb5e0000000000000000"
...
Procedure getprogparam()
  ...
  Shared Defdevice$,  privkey
  Shared threadtotal, blocktotal, pparam, waletcounter,mainpub, HT_POW
    ...
    Select LCase(ProgramParameter(i))
      Case "-h"
        Debug "found -h"
           ...
           PrintN( "-pb  Set uncompressed Pubkey, default "+mainpub)
           PrintN( "-pk  Range start from , default "+privkey)
           PrintN( " -w  Set number of items , default "+Str(waletcounter))
      ...
      Case "-pb"
       ...
       Case "-pk"
        ...
        If datares$<>"" And Left(datares$,1)<>"-"  
          ...
          PrintN( "Inital key set to 0x"+privkey)         
        EndIf 
...
Procedure Save_Load_Giants()
  ...
  filebinname$=Str(threadtotal)+"_"+Str(blocktotal)+"_"+Str(pparam)+"_"+Str(waletcounter)+"_g.BIN"
...
Shared *GiantArrPacked, *GpuHT, HT_items,HT_mask, quit

Shared threadtotal
Shared blocktotal
Shared pparam, keyMutex
Shared *CurveGX, *CurveGy, *CurveP, *Curveqn, FINDPUBG, ADDPUBG, pubkeyBIG, *PRKADDBIG, PUBADDBIG, REALPUB
Protected *counterBig, *counterBigTemp, *tempor, *MylocalPrk, MylocalPUB.CoordPoint, TestPUB.CoordPoint, *PRKADD
Protected hashd.d, wald.d = Log(waletcounter)/Log(2)
...
a$=RSet(Hex(maxnonce*waletcounter*(gpu(gpuid))), 64,"0")
Curve::m_sethex32(*PRKADD, @a$ )
Curve::m_addModX64(*MylocalPrk,*MylocalPrk,*PRKADD,*Curveqn)


PrintN("GPU #"+Str(gpuid)+" Start from Key:"+Curve::m_gethex32(*MylocalPrk))
...
Define  i, pointcount, ndev, a$, starttime, jobperthread, res, totalCPUcout, restjob
...
a$=RSet(Hex(maxnonce*waletcounter*pointcount), 64,"0")
